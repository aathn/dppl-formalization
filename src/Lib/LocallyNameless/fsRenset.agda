...
lns→Renset {X} = record
  ...
  ren₃ (ι₂ a) (ι₁ j) (ι₂ c) x =
    ...
    proof
      (j ~> c)((j <~ a)x)
    [ ap ((j ~> c) ∘ (j <~ a)) (≻3 i≻x ≤refl) ]≡
      (j ~> c)((j <~ a)((i ~> a)x))
    [ oc₈ _ _ _ _ _ ]≡
      (i ~> c)((i <~ a)((j ~> c)x))
    [ ↤fresh _ _ (~>index-supports i≻x) ]≡
      (c ↤ a)((j ~> c)x)
    qed
  ren₃ (ι₂ a) (ι₂ b) (ι₁ k) x =
    let
  ...
  ren₄ (ι₂ a) (ι₂ b) (ι₁ k) (ι₁ l) x =
    ...
    ≡[ oc₇ _ _ _ _ _ ]
      (l <~ c)((j ~> b)((j <~ a)((k ~> c)x)))
    [ ap ((l <~ c) ∘ (j ~> b)) (oc₇ _ _ _ _ _) ]≡
      (l <~ c)((j ~> b)((k ~> c)((j <~ a)x)))
    ≡[ ap (l <~ c) (oc₅ _ _ _ _ _) ]
      (l <~ c)((k ~> c)((j ~> b)((j <~ a)x)))
    [ ap ((l <~ c) ∘ (k ~> c)) (↤fresh _ _ j≻x) ]≡
      (l <~ c)((k ~> c)((b ↤ a)x))
    [ ↦fresh _ _ ]≡
      (k ↦ l)((b ↤ a)x)
    qed

...
≻↤  a b x i p j =
  let
    ...
    instance
      ...
      _ = ∉[]₁ (∉∪₂ (unfinite ([ a ] ∪ [ b ])))
      _ : j ≠ k
      _ = symm≠ k j (<→≠ j (j +1) ≤refl)
  in (c ,
    (proof
      (j ~> c)((b ↤ a)x)
    ≡[ ap (j ~> c) (↤fresh _ _ k≻x) ]
      (j ~> c)((k ~> b)((k <~ a)x))
    ≡[ oc₅ _ _ _ _ _ ]
      (k ~> b)((j ~> c)((k <~ a)x))
    ≡[ ap (k ~> b) (oc₇ _ _ _ _ _) ]
...
module _ {X : Set}{{_ : lns X}}{x : X} where
  ...
  rn₄ {a} {b} {a'} {b'} =
    ...
    ≡[ ap ((k' ~> b) ∘ (k' <~ a)) (~><~ p (≻1 ≤max₁ p)) ]
      (k' ~> b)((k' <~ a)((k ~> b')((k <~ a')x)))
    [ ap (k' ~> b) (oc₇ _ _ _ _ _ {{symm≠ k' k k'≠k}}) ]≡
      (k' ~> b)((k ~> b')((k' <~ a)((k <~ a')x)))
    ≡[ oc₅ _ _ _ _ _ {{k'≠k}} ]
      (k ~> b')((k' ~> b)((k' <~ a)((k <~ a')x)))
...
module _ {X : Set}{{_ : lns X}} where
  ...
  alt-≀ₐₐ a b i j x p q =
    ...
    ≡[ ↤fresh _ _ r ]
      (i ~> b)((i <~ c)((a ↤ b)((c ↤ a)x)))
    ≡[ ap ((i ~> b) ∘ (i <~ c)) (↤fresh _ _ s) ]
      (i ~> b)((i <~ c)((j ~> a)((j <~ b)((c ↤ a)x))))
    ≡[ ap ((i ~> b) ∘ (i <~ c) ∘ (j ~> a) ∘ (j <~ b)) (↤fresh _ _ p) ]
      (i ~> b)((i <~ c)((j ~> a)((j <~ b)((i ~> c)((i <~ a)x)))))
    [ ap ((i ~> b) ∘ (i <~ c) ∘ (j ~> a)) (oc₇ _ _ _ _ _) ]≡
      (i ~> b)((i <~ c)((j ~> a)((i ~> c)((j <~ b)((i <~ a)x)))))
    [ ap (i ~> b) (oc₇ _ _ _ _ _) ]≡
      (i ~> b)((j ~> a)((i <~ c)((i ~> c)((j <~ b)((i <~ a)x)))))
    ≡[ oc₅ _ _ _ _ _ ]
      (j ~> a)((i ~> b)((i <~ c)((i ~> c)((j <~ b)((i <~ a)x)))))
    ≡[ ap ((j ~> a) ∘ (i ~> b)) (oc₃ _ _ _) ]
      (j ~> a)((i ~> b)((i <~ c)((j <~ b)((i <~ a)x))))
    ≡[ ap ((j ~> a) ∘ (i ~> b)) (#2 it) ]
      (j ~> a)((i ~> b)((j <~ b)((i <~ a)x)))
    qed
  ...
  ... | neq f =
    ...
    proof
      (a ≀ₐₐ b)((b ≀ₐₐ a)x)
    ≡[ ≀ₐₐfresh a b c' ((b ≀ₐₐ a)x) ]
      (b ↤ c')((a ↤ b)((c' ↤ a)((b ≀ₐₐ a)x)))
    ≡[]
      (b ↤ c')((a ↤ b)((c' ↤ a)((a ↤ c)((b ↤ a)((c ↤ b)x)))))
    ≡[ ap ((b ↤ c') ∘ (a ↤ b)) rn₃ ]
      (b ↤ c')((a ↤ b)((c' ↤ c)((c' ↤ a)((b ↤ a)((c ↤ b)x)))))
    ≡[ ap (b ↤ c') (rn₄ {a = b} {a} {c} {c'}) ]
      (b ↤ c')((c' ↤ c)((a ↤ b)((c' ↤ a)((b ↤ a)((c ↤ b)x)))))
    ≡[ ap ((b ↤ c') ∘ (c' ↤ c) ∘ (a ↤ b)) (rn₂ {a = a} {c'} {b}) ]
      (b ↤ c')((c' ↤ c)((a ↤ b)((b ↤ a)((c ↤ b)x))))
    ≡[ ap ((b ↤ c') ∘ (c' ↤ c)) rn₃ ]
      (b ↤ c')((c' ↤ c)((a ↤ a)((a ↤ b)((c ↤ b)x))))
    ≡[ ap ((b ↤ c') ∘ (c' ↤ c)) rn₁ ]
      (b ↤ c')((c' ↤ c)((a ↤ b)((c ↤ b)x)))
    ≡[ ap ((b ↤ c') ∘ (c' ↤ c)) (rn₂ {a = b} {a} {c}) ]
      (b ↤ c')((c' ↤ c)((c ↤ b)x))
    ≡[ ap (b ↤ c') rn₃ ]
      (b ↤ c')((c' ↤ b)((c' ↤ c)x))
    ≡[ rn₃ ]
  ...
  ts₃ {x} {a} {b} {c} {d} =
    ...
    [ ap ((d ↤ e') ∘ (c ↤ d) ∘ (e' ↤ c)) (≀ₐₐfresh a b e x) ]≡
      (d ↤ e')((c ↤ d)((e' ↤ c)((a ≀ₐₐ b)x)))
    [ ≀ₐₐfresh c d e' ((a ≀ₐₐ b)x) ]≡
      (c ≀ₐₐ d)((a ≀ₐₐ b)x)
    qed

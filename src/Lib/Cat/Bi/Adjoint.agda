...
module Lib.Cat.Bi.Adjoint where
...
module _
  ...
  adjointᶜ→adjoint F⊣G ._⊣_.zig = ext λ _ →
    idl _ ∙∙ ap₂ _∘_ (idl _) (idl _ ∙∙ idr _ ∙∙ idr _) ∙∙ _⊣ᶜ_.zig F⊣G
    where open Precategory D
  adjointᶜ→adjoint F⊣G ._⊣_.zag = ext λ _ →
       idl _
    ∙∙ ap₂ _∘_ (idr _) (idl _ ∙∙ idr _ ∙∙ Cr.eliml C (ap (G .F₁) (F .F-id) ∙ G .F-id))
    ∙∙ _⊣ᶜ_.zag F⊣G
  ...
  adjoint→adjointᶜ F⊣G ._⊣ᶜ_.zig    =
    sym (idl _ ∙ ap₂ _∘_ (idl _) (idl _ ∙∙ idr _ ∙∙ idr _)) ∙ _⊣_.zig F⊣G ηₚ _
    where open Precategory D
